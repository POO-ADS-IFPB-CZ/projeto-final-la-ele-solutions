...
public class TelaFuncionariosCadastrados extends JFrame {
    ...
    public TelaFuncionariosCadastrados() {
        ...
        acessarButton.addActionListener(e -> {
            ...
            if (funcionarioSelecionado != null && funcionarioSelecionado instanceof Recepcionista) {
                ...
                JOptionPane.showMessageDialog(this, "O funcionário selecionado não é um Recepcionista.");
            }
        });
